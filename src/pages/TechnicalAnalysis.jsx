...
const TechnicalAnalysis = () => {
  ...
  return (
    <div className="CatagorySection">
        <Helmet>
            <title>Finkarma - Technical Analysis</title>
            <meta
                name="description"
                content="We at Finkarma offer a wide range of Technical Analysis Modules which help you in  intermediate and advanced learners." 
            />
        </Helmet>
        ...
        {postsLoading
            ? <LoadingAnimation/>
              : latestPosts.filter((post) => 
                post.post.categories === "4,2,32,38" ||
                post.post.categories === "4,32,33,38" ||
                post.post.categories === "4,36,42,32,38" ||
                post.post.categories === "4,2,32,33,38" ||
